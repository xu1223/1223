...
class uploadImg extends Component {
    ...
    componentDidMount = () => {
        console.log(this.props, this.props['data-__meta'],444444)
        if (this.props['data-__meta']) {
            this.setState({
                fileList: [{
                    ...
                    name: 'image.png',
                    status: 'done',
                    url: this.props['data-__meta'].initialValue,
                }]
            })
        }
    ...
    render() {
        ...
        return <div>
            <Upload
                action={process.env['APP_HOST_URL_API_ADMIN'] + '/api/admin/website_image_upload'}
